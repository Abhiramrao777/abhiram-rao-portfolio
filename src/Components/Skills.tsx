...
export default function Skills() {
  return (
    <section id="skills" className="py-20 px-6 bg-linear-to-b from-gray-950 to-gray-900">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-5xl font-bold text-center mb-4 text-white">SKILLS</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {skillGroups.map((group) => (
            <div key={group.title} className="space-y-6">
              <h3 className="text-3xl font-semibold text-purple-500 text-center">
                {group.title}
              </h3>
              ...
              <div className="grid grid-cols-3 gap-6 justify-items-center">
                {group.skills.map((skill) => (
                  <div key={skill.name} className="flex flex-col items-center gap-3 group">
                    <div className="w-20 h-20 p-4 bg-gray-800 rounded-2xl border border-[rgba(147,51,234,0.2)] 
                                   group-hover:border-purple-500 group-hover:scale-110 
