        ...
        <div className="text-center md:text-left space-y-6 order-2 md:order-1 z-10">
          ...
          <div className="pt-8">
            <a
              ...
              download
              className="inline-block px-8 py-4 bg-linear-to-r from-[var(--color-purple-600)] to-[var(--color-purple-500)] rounded-full text-white font-semibold text-lg hover:from-[var(--color-purple-500)] hover:to-[var(--color-purple-400)] transition-all duration-300 glow-purple"
            >
              DOWNLOAD RESUME
            </a>
          </div>
